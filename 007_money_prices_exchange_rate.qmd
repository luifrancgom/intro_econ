...
# Gráficas interactivas > CATÁLOGO DE SERIES >  
...
# Political interest rate 2024-02-01 (Colombia)
i_t <- 0.1275
date <- lubridate::ymd("2024-02-01")
```

- In the link **[https://www.banrep.gov.co/es/estadisticas/tasas-interes-politica-monetaria](https://www.banrep.gov.co/es/estadisticas/tasas-interes-politica-monetaria)** on __`r date`__ it was pointed out that:
    ...
    + Also the *"tasa de intervención de política monetaria"* on __`r date`__ was __`r scales::percent(i_t, accuracy = 0.01)`__
...
- To the __[R Core Team](https://www.r-project.org/contributors.html)__, the creators of __[RStudio IDE](https://rstudio.com/products/rstudio/)__, __[Quarto](https://quarto.org/)__ and the authors and maintainers of the packages  __[tidyverse](https://CRAN.R-project.org/package=tidyverse)__, __[knitr](https://CRAN.R-project.org/package=knitr)__, __[kableExtra](https://CRAN.R-project.org/package=kableExtra)__, __[wbstats](https://CRAN.R-project.org/package=wbstats)__, __[tidyquant](https://CRAN.R-project.org/package=tidyquant)__, and __[tinytex](https://CRAN.R-project.org/package=tinytex)__ for allowing me to access these tools without paying for a license
