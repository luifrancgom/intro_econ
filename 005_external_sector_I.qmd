...
names(bop_col_current_account_table_footnote)[2] <-paste0(names(bop_col_current_account_table_footnote)[2:3],
                                                            footnote_marker_alphabet(1, "latex"))

names(bop_col_current_account_table_footnote)[3:4] <-  paste0(names(bop_col_current_account_table_footnote)[4],
