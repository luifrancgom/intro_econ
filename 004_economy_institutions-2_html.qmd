...
$$
\text{political power}_t \Longrightarrow \text{economic institutions}_t
$$
...
$$
\text{political institutions}_t \Longrightarrow \text{de jure political power}_t
$$
...
$$
\text{distributions of resources}_t \Longrightarrow \text{de facto political power}_t
$$
...
$$
\text{political power}_t \Longrightarrow \text{political institutions}_{t+1}
$$
...
<!-- Check source code in 000_tex_files/005_acemoglu_schematic_representation_framework.tex -->
