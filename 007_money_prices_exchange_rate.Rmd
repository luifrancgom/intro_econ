...
- This presentation is based on [@cardenas_santamaria_introduccion_2013, Chapter 7]
...
- A central bank is the institution that issues and administrates legal currency and exercises the function of banker of banks [@banrep_central_2021]
...
- In the link **http://www.banrep.gov.co/es/estadisticas/tasas-interes-politica-monetaria** on __2021-09-30__ it was pointed out that:
...
```
    ...
    + Also the *"tasa de intervención de política monetaria"* on __2021-09-30__ was `r scales::percent(i_t, accuracy = 0.01)`
