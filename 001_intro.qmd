...
# Medición de Pobreza Monetaria y Desigualdad 2021 > Hogares
...
egg_junio_2023_tbl <- read_excel(path = "000_data/001_series_historicas_precios_mayoristas_2023_junio.xlsx", 
                               sheet = 7, 
                               range = "A7:E4499") %>% 
  janitor::clean_names() %>%
  select(fecha, producto:precio_promedio_por_kilogramo) %>%
