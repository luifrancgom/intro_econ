...
- By markets [@cardenas_introduccion_2020, Chapter 8, p 264]
...
credit_private_wide |> 
  ...
  labs(x        = "Domestic credit to private sector (% of GDP)",
       ...
       # Change the update date manually
...
tes_daily_t_10 |>
  ...
  labs(x        = NULL,
       y        = "Percent",
       color = NULL,
       title    = "Interest rates: TES zero coupon, COP - 10 years",
...
# Entidades vigilidas por la superintendencia financiera de Colombia >
# Lista general de entidades vigilidas por la superintendencia financiera de Colombia > 
...
bank_table |>
  ...
  footnote(general       = c('Source: Superintendencia Financiera de Colombia', 'Last update: 2024-02-04'),
           general_title = "",
           threeparttable = TRUE)
```
