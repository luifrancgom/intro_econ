...
trade_usa_col_world_sgp_clean |>
  ...
  labs(
    ...
    color = NULL,
    subtitle = str_glue(
      "Period: {min(trade_usa_col_world_sgp_clean$date)}-{max(trade_usa_col_world_sgp_clean$date)}"
    ),
    caption = str_glue(
...
bop_col_current_account_table |>
  ...
  tab_footnote(
    footnote = "Preliminary data (Millions of current USD)",
    locations = cells_column_labels(
      columns = c(
        `2025`
      )
...
table_bop_example <- tibble(
  ...
  "Credit" = c("100", "100", "100", "", "25", "", "5", "20", "125"),
  "Debit" = c("-5", "-5", "", "-5", "-120", "-20", "-100", "", "-125"),
  "Net" = c("95", "95", "100", "-5", "-95", "-20", "-75", "", "0")
)
```
...
table_bop_example |>
  ...
  tab_footnote(
    ...
    locations = list(
      cells_body(rows = 3, columns = "Credit"),
      cells_body(rows = 7, columns = "Debit")
    ),
    placement = "right"
  ) |>
  tab_footnote(
    ...
    locations = list(
      cells_body(rows = 4, columns = "Debit"),
      cells_body(rows = 7, columns = "Credit")
    ),
    placement = "right"
  ) |>
  tab_footnote(
    ...
    locations = list(
      cells_body(rows = 6, columns = "Debit"),
      cells_body(rows = 8, columns = "Credit")
    ),
    placement = "right"
  ) |>
  tab_style(
