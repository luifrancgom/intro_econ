...
- Colombian goods exports __(HS 4 digits Version 1992)__ year 1995 [@oec_observatory_2022]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_export_hs4_version1992_1995.png")
```

# Patterns of international trade: goods

- Colombian goods exports __(HS 4 digits Version 1992)__ year 2020 [@oec_observatory_2022]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_export_hs4_version1992_2020.png")
```

# Patterns of international trade: goods

- Colombian goods imports __(HS 4 digits Version 1992)__ year 1995 [@oec_observatory_2022]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_import_hs4_version1992_1995.png")
```

# Patterns of international trade: goods

- Colombian goods imports __(HS 4 digits Version 1992)__ year 2020 [@oec_observatory_2022]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_import_hs4_version1992_2020.png")
```
...
- Colombian services exports __(EBOPS Version 2002)__ year 2000 [@oec_observatory_2022]
...
- Colombian services imports __(EBOPS Version 2002)__ year 2000 [@oec_observatory_2022]
...
- Colombian services exports __(EBOPS Version 2002)__ year 2020 [@oec_observatory_2022]

```{r out.width="55%"}
knitr::include_graphics(path = "000_data/005_col_export_ebops_version2002_2020.png")
```

# Patterns of international trade: services

- Colombian services imports __(EBOPS Version 2002)__ year 2020 [@oec_observatory_2022]

```{r out.width="55%"}
knitr::include_graphics(path = "000_data/005_col_import_ebops_version2002_2020.png")
```
