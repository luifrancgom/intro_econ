...
- **ingtotug**: _"Ingreso total de la unidad de gasto **antes** de imputación de arriendo a propietarios y usufructuarios"_ [@dnp_pobreza_2012, pp. 16-17]
...
- If you want to explore more about this topic using data from the year 2019 check out[^1]:
    ...
    -   [https://www.ofiscal.org/](https://www.ofiscal.org/) > Interactúa > Calcule dónde se ubica su hogar según su ingreso →
...
- If you want to explore more about this topic from around the world in a visual way check out[^2]:
    ...
    -   [https://www.gapminder.org](https://www.gapminder.org) > Resources > Tools > Dollar Street
...
- To the __[Business Science](https://www.business-science.io/)__ and __[R4DS Online Learning](https://www.rfordatasci.com/)__ communities where I learn __[R](https://www.r-project.org/about.html)__ and __[$\pi$-thon](https://www.python.org/about/)__  
