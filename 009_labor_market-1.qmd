...
labor_classification_concept <- read_excel(path = "000_data/009_anexo_empleo_feb_28.xlsx",
                                           sheet = "Total nacional", 
                                           range = "A23:A30", 
                                           col_names = "concept")

# This is the part that needs to be updated
labor_classification_last_data <- read_excel(path = "000_data/009_anexo_empleo_feb_28.xlsx",
                                             sheet = "Total nacional", 
                                             range = "KD23:KD30",
                                             col_names = "value") |> 
...
tibble(x = c( 0, 
  ...
  labs(# This part needs to be update manually
    subtitle = str_glue('Period: January 2025'),
