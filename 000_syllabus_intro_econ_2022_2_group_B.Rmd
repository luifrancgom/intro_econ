...
- September 26
    ...
    + __Virtual meeting Presentation Syllabus__
        ...
        + __Prerequisites__:
            + Review the course program in advance, which can be downloaded by following the route _Primer corte 30% > Learning Resources > Support material > Presentations > 000_syllabus_intro_econ_2022_2_
...
- [@cardenas_introduccion_2020, Chapters 1-9]
    ...
    + https://www.umng.edu.co/inicio > Biblioteca >  Ingreso a Bases Virtuales & Ebooks > AlfaOmega  > Ingresar usuario y contraseña [^1] > Buscar  "Introducción a la economía colombiana 4ed" > Leer
