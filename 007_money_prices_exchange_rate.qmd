...
[^1]: For a list of central banks around the world check out **[https://www.bis.org/cbanks.htm](https://www.bis.org/cbanks.htm)**
...
# Political interest rate 2023-07-19 (Colombia)
i_t <- 0.1325 
```

- In the link **[https://www.banrep.gov.co/es/estadisticas/tasas-interes-politica-monetaria](https://www.banrep.gov.co/es/estadisticas/tasas-interes-politica-monetaria)** on __2023-07-19__ it was pointed out that:
    ...
    + Also the *"tasa de intervención de política monetaria"* on __2023-07-19__ was `r scales::percent(i_t, accuracy = 0.01)`
...
![**Interest rate and credit** [@banrep_canales_2020, fig. Canal De Tasa De Interés Y De Crédito: Ejemplo Gráfico]](_000_images/007_econo_canales_transmision_1_tasa_interes_credito.jpg){#fig-canal_tasa_interes_credito fig-alt="Interest rate and credit" fig-align="center" width="450px" height="450px"}

# Monetary policy transmission channels

![**Exchange rate** [@banrep_canales_2020, fig. Canal De Tasa De Cambio: Ejemplo Gráfico]](_000_images/007_econo_canales_transmision_2_tasa_cambio.jpg){#fig-canal_tasa_de_cambio fig-alt="Tasa de Cambio" fig-align="center" width="450px" height="600px"}

# Monetary policy transmission channels

![**Expectations** [@banrep_canales_2020, fig. Canal De Las Expectativas: Ejemplo Gráfico]](_000_images/007_econo_canales_transmision_3_expectativas.jpg){#fig-canal_expectativas fig-alt="Expectativas" fig-align="center" width="400px" height="400px"}
