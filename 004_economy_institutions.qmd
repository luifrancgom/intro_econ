...
- Where can I find data?
    ...
    + Doing Business - World Bank: 
        ...
        + [https://www.doingbusiness.org/](https://www.doingbusiness.org/) > Explore Data Details > Select and economy: Colombia > Download Profile
        
        + [https://databank.worldbank.org/source/doing-business](https://databank.worldbank.org/source/doing-business)
        
- What is the methodology?

    + [https://www.doingbusiness.org/](https://www.doingbusiness.org/) > Methodology
...
db_col_2020 %>%
  ...
  labs(x = NULL,
       ...
       caption = str_glue("Source: Doing Business - World Bank
                          Last update: {unique(db_col_2020$last_updated)}")) +
  theme(panel.border    = element_rect(fill = NA, color = "black"),
        plot.background   = element_rect(fill = "#f3fcfc"),
        panel.background  = element_rect(fill = "#f3f7fc"),
        legend.background = element_rect(fill = "#f3fcfc"),
...
homicide_1990_2020_pivot_wider <- homicide_1990_2020 %>% 
...
homicide_1990_2020_pivot_wider %>% 
  ggplot(aes(x = `1990`, y = `2020`))  + 
  geom_abline(slope = 1, color = 'black') +
  geom_point(shape = 21, 
             size = 4,
             fill = "red") + 
  geom_label_repel(data = homicide_1990_2020_pivot_wider %>% 
  ...
  labs(fill = NULL, 
       ...
       subtitle = str_glue("Number of countries: {nrow(homicide_1990_2020_pivot_wider)}"),
       caption = str_glue("Source: World Development Indicators - World Bank
                          Last update: {unique(homicide_1990_2020$last_updated)}")) + 
  theme(panel.border    = element_rect(fill = NA, color = "black"),
        plot.background   = element_rect(fill = "#f3fcfc"),
        panel.background  = element_rect(fill = "#f3f7fc"),
        legend.background = element_rect(fill = "#f3fcfc"),
...
homicide_female_1990_2020_pivot_wider <- homicide_female_1990_2020 %>% 
...
homicide_female_1990_2020_pivot_wider %>% 
  ggplot(aes(x = `1990`, y = `2020`)) + 
  geom_abline(slope = 1, color = 'black') +
  geom_point(shape = 21, 
             size = 4,
             fill = "red") + 
  geom_label_repel(data = homicide_female_1990_2020_pivot_wider %>% 
                     filter(country == "Colombia"),
                   aes(label = country), 
                   seed = 1234,                    
                   box.padding = 1) + 
  ...
  labs(fill = NULL, 
       ...
       subtitle = str_glue("Number of countries: {nrow(homicide_female_1990_2020_pivot_wider)}"),
       caption = str_glue("Source: World Development Indicators - World Bank
                          Last update: {unique(homicide_female_1990_2020$last_updated)}")) + 
  theme(panel.border    = element_rect(fill = NA, color = "black"),
        plot.background   = element_rect(fill = "#f3fcfc"),
        panel.background  = element_rect(fill = "#f3f7fc"),
        legend.background = element_rect(fill = "#f3fcfc"),
...
homicide_male_1990_2020_pivot_wider <- homicide_male_1990_2020 %>% 
...
homicide_male_1990_2020_pivot_wider %>% 
  ggplot(aes(x = `1990`, y = `2020`)) + 
  geom_abline(slope = 1, color = 'black') +
  geom_point(shape = 21, 
             size = 4,
             fill = "red") + 
  geom_label_repel(data = homicide_male_1990_2020_pivot_wider %>% 
                     filter(country == "Colombia"),
                   aes(label = country), 
                   seed = 1234,                    
                   box.padding = 1) + 
  ...
  labs(fill = NULL, 
       ...
       subtitle = str_glue("Number of countries: {nrow(homicide_male_1990_2020_pivot_wider)}"),
       caption = str_glue("Source: World Development Indicators - World Bank
                          Last update: {unique(homicide_male_1990_2020$last_updated)}")) + 
  theme(panel.border    = element_rect(fill = NA, color = "black"),
        plot.background   = element_rect(fill = "#f3fcfc"),
        panel.background  = element_rect(fill = "#f3f7fc"),
        legend.background = element_rect(fill = "#f3fcfc"),
