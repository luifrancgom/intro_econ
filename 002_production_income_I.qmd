...
- Output/Production approach (Colombia, Period: 2023-Q3)
...
# Información técnica > Anexos estadísticos PIB producción >
# PIB a precios corrientes
gdp_agg_value <- read_excel("000_data/002_anexos_produccion_corrientes_III_2023.xlsx", 
                            sheet = 2, 
                            range = "C15:BZ29", 
                            col_names = FALSE)
...
gdp_agg_value_table <- gdp_agg_value |> 
  ...
  rename(concept = `...1`, value_last = `...76`) |>  
...
gdp_agg_value_table_footnote |>  
  ...
  footnote(general       = c('Source: DANE - Cuentas Nacionales Trimestrales - Producto Interno Bruto desde el enfoque de la producción a precios corrientes - Cuadro 1 Datos originales', 'Last update: 2023-11-15'), 
           general_title = "",
...
- Income approach (Colombia, Period: 2023-Q3)
...
# PIB a precios corrientes
gdp_income <- read_excel("000_data/002_anexos_ingreso_corrientes_III_2023.xlsx",
                         sheet = 1,
                         range = "C14:AI42",
                         col_names = FALSE)
...
gdp_income_table <- gdp_income |>
  ...
  rename(concept = `...1`, value_last = `...33`) |>
  slice(1:3, 16, 29) |>
  mutate(value_last = round(value_last, digits = 0))
...
gdp_income_table_footnote |>
  ...
  footnote(general       = c('Source: DANE - Cuentas Nacionales Trimestrales - PIB por Ingreso - S1 Total Economía', 'Last update: 2023-12-27'),
           general_title = "",
...
- Expenditure/Final demand approach (Colombia, Period: 2023-Q3)
...
# PIB a precios corrientes
gdp_expenditure <- read_excel("000_data/002_anexos_gasto_corrientes_III_2023.xlsx",
                              sheet = 2,
                              range = "B15:BY21",
                              col_names = FALSE)
...
gdp_expenditure_table_footnote |>
  ...
  footnote(general       = linebreak(c('Source: DANE - Cuentas Nacionales Trimestrales - Producto Interno Bruto desde el enfoque del gasto a precios corrientes - Cuadro 1 Datos originales', 'Last update: 2023-11-15')),
           general_title = "",
...
- To the __[R Core Team](https://www.r-project.org/contributors.html)__, the creators of __[RStudio IDE](https://rstudio.com/products/rstudio/)__, __[Quarto](https://quarto.org/)__ and the authors and maintainers of the packages __[tidyverse](https://CRAN.R-project.org/package=tidyverse)__, __[readxl](https://CRAN.R-project.org/package=readxl)__, __[knitr](https://CRAN.R-project.org/package=knitr)__, __[kableExtra](https://CRAN.R-project.org/package=kableExtra)__, __[tidyquant](https://CRAN.R-project.org/package=tidyquant)__, __[wbstats](https://CRAN.R-project.org/package=wbstats)__ and __[tinytex](https://CRAN.R-project.org/package=tinytex)__ for allowing me to access these tools without paying for a license
