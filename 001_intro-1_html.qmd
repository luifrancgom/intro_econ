...
posicion_ideologica_clean |>
  ...
  labs(
    ...
    caption = str_glue(
      "Source: DANE - Encuesta de Cultura Política - ECP - 2023
...
household_income_nper_tbl |>
  ...
  labs(
    x = NULL,
    y = "Monthly mean income range (2024 COP)",
    subtitle = str_glue(
      "Year: 2024
    ...
    caption = str_glue(
      "Source: DANE - Medición de Pobreza Monetaria y Desigualdad 2024
...
schools_bilin_tbl |>
  ...
  labs(
    ...
    caption = str_glue(
      "Source: DANE - Educación Formal - 2023 - Carátula única sede educativa
