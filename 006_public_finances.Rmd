...
- [@oecd_revenue_2021, p 2]

```{r out.width="90%"}
knitr::include_graphics(path = "000_data/006_tax_to_GDP_OECD_2020.png")
```
...
#         axis.text         = element_text(face = "bold"))
```
- [@oecd_revenue_2021, p 3]

```{r out.width="90%"}
knitr::include_graphics(path = "000_data/006_tax_structure_vs_oedc_average.png")
```
