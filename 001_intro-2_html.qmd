...
# Import
egg_jan_2021_tbl <- read_excel(
  path = "000_data/001_series_historicas_precios_mayoristas_2021_jan_july.xlsx",
  sheet = 2,
  range = "A7:E4608"
) |>
  clean_names() |>
...
egg_may_2025_tbl <- read_excel(
  path = "000_data/001_series_historicas_precios_mayoristas_2025_jan_may.xlsx",
  sheet = 1,
  range = "A6:F22500"
) |>
  clean_names() |>
