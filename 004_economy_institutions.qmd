...
homicide_female_pivot_wider |> 
  ...
  scale_fill_tq() +
  labs(fill = NULL, 
       title = "Intentional homicides, female (per 100,000 female): {initial_year} vs {last_year}",
...
homicide_male_pivot_wider |> 
  ...
  scale_fill_tq() +
  labs(fill = NULL, 
       title = "Intentional homicides, male (per 100,000 male): {initial_year} vs {last_year}",
