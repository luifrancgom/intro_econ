...
household_tbl <- read_delim(file = "000_data/001_hogares_pobreza_monetaria_desigualdad_2021.csv", 
                                   delim = ",", 
...
household_income_nper_tbl %>% 
  ...
  labs(x = NULL,
       y = "Income range (2021 COP)",
       title = "Household income distribution in Colombia",
       subtitle = str_glue("Year: 2021
       ...
       caption = str_glue('Source: DANE - Medición de Pobreza Monetaria y Desigualdad 2021
...
```{r out.width = "85%"}
# https://www.dane.gov.co/ > Datos Abiertos Microdatos y Metadatos >
# Sociedad > Educación > Educación Formal 2020 > Obtener Microdatos >
# Caratula única sede educativa
schools_tbl <- read_delim(file = "000_data/001_caratula_unica_sede_educativa_2020.csv", 
                                   delim = ";", 
                                   locale = locale(decimal_mark = ","))
...
egg_dic_2022_tbl <- read_excel(path = "000_data/001_series_historicas_precios_mayoristas_2022_dic.xlsx", 
                           sheet = 13, 
                           range = "A7:E4481") %>% 
  janitor::clean_names() %>%
  select(fecha, producto:precio_promedio_por_kilogramo) %>%
