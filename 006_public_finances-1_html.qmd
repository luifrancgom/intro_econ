...
-   Useful resources
    ...
    -   **Global Revenue Statistics Database**
        ...
        -   [**https://data-explorer.oecd.org/**](https://data-explorer.oecd.org/) \> Taxation \> Global tax revenues \> A comparative table of tax revenues for Revenue Statistics in Latin America and the Caribbean
...
## Taxation >
## Global tax revenues >
## A comparative table of tax revenues for Revenue Statistics in Latin America and the Caribbean
...
# Import
global_revenue_statistics_data_base <- read_csv(file = "000_data/006_OECD.CTP.TPS,DSD_REV_COMP_LAC@DF_RSLAC,2.0+A9+OECD_REP+COL..S13.T_1100+T_1200+T_1300+T_2000+T_3000+T_4000+T_5111+T_5112+T_5113+T_5120+T_5130+T_5200+T_5300+T_6000+_T..PT_OTR_SECTOR+PT_B1GQ.A.csv")
...
tax_revenue_as_pct_of_gdp <- global_revenue_statistics_data_base |>
  clean_names() |>
  filter(
    institutional_sector == "General government",
