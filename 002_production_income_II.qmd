...
gdp_expenditure_annual_table <- gdp_expenditure_annual |> 
  ...
  mutate(concept = case_when(
    concept == "Gasto de consumo final individual de los hogares; gasto de consumo final de las ISFLSH1" ~ "Gasto de consumo final individual de los hogares y las ISFLH",
    concept == "Gasto de consumo final de las ISFLSH1" ~ "Gasto de consumo final de las ISFLSH",
    TRUE ~ concept),
...
gdp_expenditure_annual_table_footnote |> 
  ...
  footnote(general       = c('Source: DANE - Cuentas Nacionales Anuales - Producto Interno Bruto (PIB) - Series encadenadas de volumen con año de referencia 2015', 'Last update: 2023-02-15'),
           general_title = "",
...
gdp_expenditure_annual_current_table <- gdp_expenditure_annual_current |>
  ...
  rename(concept = `...1`, value_2015 = `...12`, value_2020 = `...17`, value_2021 = `...18`) |>
  mutate(concept = case_when(
    concept == "Gasto de consumo final individual de los hogares; gasto de consumo final de las ISFLSH1" ~ "Gasto de consumo final individual de los hogares y las ISFLSH",
    concept == "Gasto de consumo final de las ISFLSH1" ~ "Gasto de consumo final de las ISFLSH",
    TRUE ~ concept),
    value_2015 = round(as.numeric(value_2015), digits = 0),
    value_2020 = round(as.numeric(value_2020), digits = 0),
...
gdp_expenditure_annual_current_table_footnote |>
  ...
  row_spec(row = 7, background = '#FF7F00') |>
  row_spec(row = 8, background = '#e31a1c') |>
  footnote(general       = c('Source: DANE - Cuentas Nacionales Anuales - Producto Interno Bruto (PIB) - Precios corrientes', 'Last update: 2023-02-15'),
           general_title = "",
           alphabet = c(# 'Provisional data',
                        'Preliminary data',
...
- To the __[R Core Team](https://www.r-project.org/contributors.html)__, the creators of __[RStudio IDE](https://rstudio.com/products/rstudio/)__, __[Quarto](https://quarto.org/)__ and the authors and maintainers of the packages  __[tidyverse](https://CRAN.R-project.org/package=tidyverse)__, __[readxl](https://CRAN.R-project.org/package=readxl)__, __[knitr](https://CRAN.R-project.org/package=knitr)__, __[kableExtra](https://CRAN.R-project.org/package=kableExtra)__, __[janitor](https://CRAN.R-project.org/package=janitor)__, __[treemapify](https://CRAN.R-project.org/package=treemapify)__,
