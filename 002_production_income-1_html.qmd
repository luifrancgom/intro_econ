...
# Import
gdp_agg_value <- read_excel("000_data/002_anexos_produccion_corrientes_III_2025.xlsx",
  sheet = 2,
  range = "C15:CH29",
  col_names = FALSE
)
...
gdp_agg_value_table <- gdp_agg_value |>
  ...
  rename(concept = `...1`, value_last = `...84`)

## Helpers
last_update_gdp_agg_value <- ymd("2025-11-18")
...
#| tbl-cap: Output/Production approach I (Colombia, 2025-Q3)
...
#| tbl-cap: Output/Production approach II (Colombia, 2025-Q3)
#| html-table-processing: none
...
# Import
gdp_income <- read_excel("000_data/002_anexos_ingreso_corrientes_III_2025.xlsx",
  sheet = 2,
  range = "C14:AQ42",
  col_names = FALSE
)
...
gdp_income_table <- gdp_income |>
  ...
  rename(concept = `...1`, value_last = `...41`) |>
  slice(1:3, 16, 29)

## Helpers
last_update_gdp_income <- ymd("2025-12-26")
```

```{r}
#| label: tbl-income-approach
#| tbl-cap: Income approach (Colombia, 2025-Q3)
#| html-table-processing: none
...
# Import
gdp_expenditure <- read_excel("000_data/002_anexos_gasto_corrientes_III_2025.xlsx",
  sheet = 2,
  range = "B15:CG21",
  col_names = FALSE
)
...
## Helpers
last_update_gdp_expenditure <- ymd("2025-11-18")
```

```{r}
#| label: tbl-expenditure-approach
#| tbl-cap: Expenditure/Final demand approach (Colombia, 2025-Q3)
#| html-table-processing: none
...
![Applying a population adjustment](_000_images/002_image2.png){.nostretch #fig-population-adjustment width=50% fig-align="center"}

##

```{r}
# Import
real_gdp_per_capita_col <- wb_data(country   = c("COL"),
...
value_base_year <- number(x = real_gdp_per_capita_col_vector["2015"][[1]], 
                          big.mark = ",", 
                          prefix = "$")
```
...
[**wbstats**](https://CRAN.R-project.org/package=wbstats), [**scales**](https://CRAN.R-project.org/package=scales) and [**tinytex**](https://CRAN.R-project.org/package=tinytex) for allowing me to access these tools without paying for a license
