...
- This presentation is based on [@cardenas_santamaria_introduccion_2013, Chapter 5]
...
- Colombian goods exports __(HS 2 digits Version 1992)__ year 1995 [@oec_observatory_2021]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_export_hs2_version1992_1995.png")
```

# Patterns of international trade: goods

- Colombian goods exports __(HS 2 digits Version 1992)__ year 2019 [@oec_observatory_2021]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_export_hs2_version1992_2019.png")
```

# Patterns of international trade: goods

- Colombian goods imports __(HS 2 digits Version 1992)__ year 1995 [@oec_observatory_2021]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_import_hs2_version1992_1995.png")
```

# Patterns of international trade: goods

- Colombian goods imports __(HS 2 digits Version 1992)__ year 2019 [@oec_observatory_2021]

```{r out.width="100%"}
knitr::include_graphics(path = "000_data/005_col_import_hs2_version1992_2019.png")
```
...
- Colombian services exports __(EBOPS Version 2002)__ year 2000 [@oec_observatory_2021]

```{r out.width="60%"}
knitr::include_graphics(path = "000_data/005_col_export_ebops_version2002_2000.png")
```

# Patterns of international trade: services

- Colombian services imports __(EBOPS Version 2002)__ year 2000 [@oec_observatory_2021]

```{r out.width="60%"}
knitr::include_graphics(path = "000_data/005_col_import_ebops_version2002_2000.png")
```

# Patterns of international trade: services

- Colombian services exports __(EBOPS Version 2002)__ year 2019 [@oec_observatory_2021]

```{r out.width="60%"}
knitr::include_graphics(path = "000_data/005_col_export_ebops_version2002_2019.png")
```

# Patterns of international trade: services

- Colombian services imports __(EBOPS Version 2002)__ year 2019 [@oec_observatory_2021]

```{r out.width="60%"}
knitr::include_graphics(path = "000_data/005_col_import_ebops_version2002_2019.png")
```

# Observatory of Economic Complexity (OEC)

- "The Observatory of Economic Complexity (OEC) is an online data visualization and distribution platform focused on the geography and dynamics of economic activities" [@oec_observatory_2021]

- "The OEC is currently designed and developed by Datawheel, but it began as a research project at MIT's Collective Learning group (former Macro Connections Group)" [@oec_observatory_2021]

# Observatory of Economic Complexity (OEC)

- Tree map

    + https://oec.world/ > TOOLS > Tree map
...
- Profiles
    ...
    + https://oec.world/ > PROFILES > Countries > Colombia
