...
household_tbl <- read_delim(
  file = "000_data/001_hogares_pobreza_monetaria_desigualdad_2023.csv",
  delim = ",",
...
# Helpers
last_update_household <- ymd("2024-09-02")
```
...
household_income_nper_tbl |>
  ...
  labs(
    ...
    caption = str_glue(
      "Source: DANE - Medición de Pobreza Monetaria y Desigualdad 2023
...
-   If you want to explore more about this topic using data from the year 2019 check out[^2]:
...
household_income_nper_tbl |>
  ...
  labs(
    ...
    caption = str_glue(
      'Source: DANE - Medición de Pobreza Monetaria y Desigualdad 2022
                          Last update date: {last_update_household}'
    )
  ) +
  theme(
...
schools_bilin_tbl |>
  ...
  labs(
    ...
    caption = str_glue(
      "Fuente: DANE - Educación Formal - 2023 - Carátula única sede educativa
