...
-   Check the message **Welcome greeting** published in the News
    Bulletin Board.

-   Dear student please edit your profile uploading a photo where your
    face is clearly visible.

-   The purpose of the virtual meetings is to answer questions and not
    to make a summary of the study material.

-   This presentation is based on [@cardenas_introduccion_2020, Chapter
    1]
...
-   **ingtotug**: *"Ingreso total de la unidad de gasto **antes** de
    imputación de arriendo a propietarios y usufructuarios"*
    [@dnp_pobreza_2012, pp. 16-17]
...
-   **ingtotugarr**: "Ingreso total de la unidad de gasto con imputación
    de arriendo a propietarios y usufructuarios" [@dnp_pobreza_2012, pp.
    24-26]

    -   Modulo B Datos de la Vivienda: 11. Si tuviera que pagar arriendo
        por esta vivienda, ¿cuánto estima que tendría que pagar
        mensualmente? [@dane_cuestionario_2019, p 2]
...
-   If you want to explore more about this topic using data from the
    year 2019 check out[^1]:

    -   <https://www.ofiscal.org/> \> Interactúa \> Calcule dónde se
        ubica su hogar según su ingreso →

        -   <https://www.ofiscal.org/ingresosxhogares>

-   If you want to explore more about this topic from around the world
    in a visual way check out[^2]:

    -   [See how the rest of the world lives, organized by
        income](https://youtu.be/u4L130DkdOw) (Configure spanish
        subtitles in the setting options)

    -   <https://www.gapminder.org> \> Resources \> Tools \> Dollar
        Street
...
-   The concept of housing (vivienda) is different from a household
    ...
    -   For a detail definition of a househould check out
        [@united_nations_principles_2017, p. 38, 2.33]

[^3]: For a detail definition of these categories checkout
    [@dane_manual_2022, p. 35]
...
```{r}
#| label: fig-manufacturing-sector-col
#| fig-cap: Distribution of aggregate value in the manufacturing Colombian sector
...
manufac_tbl |>  
  ...
  labs(x = NULL, 
       ...
       title = "Aggregate value = Gross production - Intermediate consumption",
...
egg_junio_2024_tbl <- read_excel(path = "000_data/001_series_historicas_precios_mayoristas_2024_junio.xlsx", 
                                 sheet = 1, 
                                 range = "A6:E27020") |>  
  janitor::clean_names() |> 
  select(fecha, producto:precio_promedio_por_kilogramo) |> 
...
egg_jan_june_tbl <- egg_jan_2021_tbl |>  
  bind_rows(egg_junio_2024_tbl) |> 
...
-   Example *Declaración de Renta Gustavo Francisco Petro Urrego Año
    Gravable 2019*:
...
-   To the taxpayers of Colombia and the [**UMNG
    students**](https://www.umng.edu.co/estudiante) who pay my salary

-   To the [**Business Science**](https://www.business-science.io/) and
    [**R4DS Online Learning**](https://www.rfordatasci.com/) communities
    where I learn [**R**](https://www.r-project.org/about.html) and
    [**$\pi$-thon**](https://www.python.org/about/)

-   To the [**R Core
    Team**](https://www.r-project.org/contributors.html), the creators
    of [**RStudio IDE**](https://rstudio.com/products/rstudio/),
    [**Quarto**](https://quarto.org/) and the authors and maintainers of
    the packages
    ...
    [**ggrepel**](https://CRAN.R-project.org/package=ggrepel), and
    [**tinytex**](https://CRAN.R-project.org/package=tinytex) for
    allowing me to access these tools without paying for a license

-   To the [**Linux kernel
    community**](https://www.kernel.org/category/about.html) for
    allowing me the possibility to use some [**Linux
    distributions**](https://static.lwn.net/Distributions/) as my main
    [**OS**](https://en.wikipedia.org/wiki/Operating_system) without
