...
## Direct link
## https://www.bvc.com.co/indices/msci%20colcap
## Canastas >
## Canasta vigente
...
last_update_current_index_basket_msci_colcap <- ymd("2026-02-10")
```
...
last_update_bank <- ymd("2026-02-10")
```
