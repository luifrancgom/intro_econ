...
```{r out.width="90%"}
# Data
# https://www.bvc.com.co/pps/tibco/portalbvc > Índices > MSCI COLCAP # Información detallada > MSCI COLCAPf
...
bank_table %>%
  ...
  footnote(general       = c('Source: Superintendencia Financiera de Colombia', 'Last update: 2022-06-16'),
           general_title = "",
           threeparttable = TRUE)
```
