...
cng_fb_table_footnote %>% 
  ...
  footnote(general       = c('Source: Ministerio de Hacienda y Crédito Público - Balance Gobierno Nacional Central', 'Last update: 2023-07-18'),
           general_title = "",
...
- Useful resources
    ...
    + **Guía ciudadana a la tributación  y el gasto del Estado colombiano** [@observatorio_fiscal_de_la_universidad_javeriana_guiciudadana_2018]
        ...
        + **[https://www.ofiscal.org/publicaciones](https://www.ofiscal.org/publicaciones)** > guías ciudadanas
...
![Horizontal](_000_images/006_horizontal_equity.png){#fig-horizontal width="190px" height="190px"}

![Vertical](_000_images/006_vertical_equity.png){#fig-vertical width="190px" height="190px"}

Horizontal and vertical [@observatorio_fiscal_de_la_universidad_javeriana_guiciudadana_2018, p 8]
:::
...
Regressive, proportional and progressive tax [@observatorio_fiscal_de_la_universidad_javeriana_guiciudadana_2018, p 11]
:::
...
global_revenue_statistics_data_base <- read_csv(file = '000_data/006_RS_GBL_tax_revenue_as_pct_of_gdp.zip')
```
...
- Useful resources
    ...
    + **Guía ciudadana a la tributación  y el gasto del Estado colombiano** [@observatorio_fiscal_de_la_universidad_javeriana_guiciudadana_2018]
        ...
        - **[https://www.ofiscal.org/](https://www.ofiscal.org/)** > Guias
...
# Ejecución
pgn_what_spent <- read_csv(file = '000_data/006_quien_gasta_PTE.csv', 
